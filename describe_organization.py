...
def describe_accounts(orgs_client, accounts):
    ...
    for account in accounts:
        acc = orgs_client.describe_account(
...
def describe_org_units(orgs_client, ous):
    ...
    for ou in ous:
        desc = orgs_client.describe_organizational_unit(
            OrganizationalUnitId=ou['ou_id'])['OrganizationalUnit']
...
def main():
    parser = argparse.ArgumentParser(
        description='Describes your AWS organization')
    parser.add_argument('-o', '--output', default='organization.json',
